...
__For a limited time, AutoFeedback (normally Enterprise tier) is enabled for all accounts.__
...
The onboarding screen can be accessed from the menu in the bottom left.
![Onboarding menu](/images/docs/autofeedback/getting-started.png)

Clicking on `Summary grading` creates a summarization task with associated feedback. To generate feedback, log completions with the tag `log10/summary-grading` to your organization.
![Onboarding task](/images/docs/autofeedback/onboarding-task.png)