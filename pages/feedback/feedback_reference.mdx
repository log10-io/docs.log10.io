...
- `completion_tags_selector`: A list of tags associated with the feedback. Note that this is different from the task completion tags selector used for log matching in the inbox. For more information, see [log matching](/feedback/log_matching).
