...
Once you're done, you'll have a command line app that looks like this.
...
Navigate from the Log10 dashboard to the Logs page. You should see your test completion has just been logged. 
...
Once again, you can see everything logged to your Log10 dashboard.
...
You can now navigate from the Log10 dashboard to the Feedback page, and you will see your newly logged feedback. 

![Screenshot showing the logged feedback](/images/docs/feedback/tutorial/feedback.png)
