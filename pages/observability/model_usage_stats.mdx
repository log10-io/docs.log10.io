...
| `startDate`       | No       | The start date of the range to retrieve stats for. Defaults to current Date.                                                                            |
| `endDate`         | No       | The end date of the range to retrieve stats for. Defaults to `startDate` plus one day.                                                                  |
