...
| `startDate`       | No       | The start date of the range to retrieve stats for. Defaults to current Date.                                                                            | Date   | "2024-01-01"     |
| `endDate`         | No       | The end date of the range to retrieve stats for. Defaults to `startDate` plus one day.                                                                  | Date   | "2024-01-02"     |
