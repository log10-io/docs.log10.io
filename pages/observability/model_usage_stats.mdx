...
| `start_date`      | No       | The start date of the range to retrieve stats for. Defaults to current Date.                                                                            |
| `end_date`        | No       | The end date of the range to retrieve stats for. Defaults to `startDate` plus one day.                                                                  |
